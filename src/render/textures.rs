...
impl Textures {
    ...
    pub fn new(gpu: &Gpu) -> Self {
        ...
        let forest_texture = Self::load_texture("assets/seamless-forest.jpg", gpu);
        let forest_view = forest_texture.create_view(&wgpu::TextureViewDescriptor::default());
        let city_texture = Self::load_texture("assets/seamless-city.jpg", gpu);
        let city_view = city_texture.create_view(&wgpu::TextureViewDescriptor::default());
        let river_texture = Self::load_texture("assets/seamless-river.jpg", gpu);
        let river_view = river_texture.create_view(&wgpu::TextureViewDescriptor::default());
        let wheat_texture = Self::load_texture("assets/seamless-wheat.jpg", gpu);
